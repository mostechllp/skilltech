      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-3">
            <img src={logo} alt="Skill Tech Logo" className="h-20 w-auto" />
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3">
              {[
                ...
                { key: 'dvdReceiverCpuMounts', text: t('dvdReceiverCpuMounts') },
                { key: 'cctvCameraBrackets', text: t('cctvCameraBrackets') },
                { key: 'otherMountsAccessories', text: t('otherMountsAccessories') },
